...
class GameController extends Controller
{
    ...
    public function generaCandidati()
    {
        ...
        if ($totalCurrent >= 50) {
            return redirect("/games/{$game->id}/candidati")->with(
                "error",
                "Hai già 50 candidati disponibili!",
            );
        }
        ...
        return redirect("/games/{$game->id}/candidati")->with(
            "success",
            "Generati 3 dev e 1 sale! Totale candidati disponibili: " .
                ($currentDevs + 3 + $currentSales + 1),
        );
    }
    ...
    public function assumiCandidato()
    {
        ...
        return redirect("/games/{$game->id}/candidati")->with(
            "success",
            "Candidato assunto con successo!",
        );
    }
